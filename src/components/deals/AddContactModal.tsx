...
import { validateSchema, contactValidationSchema, ValidationResult } from '../../utils/validation';
...
export const AddContactModal: React.FC<AddContactModalProps> = ({
  ...
  const validateForm = (): ValidationResult => {
    ...
    const validation = validateSchema(dataToValidate, contactValidationSchema);
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div>
                  ...
                  <input
                    ...
                    className={`w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 ${
                      formErrors.firstName?.length ? 'border-red-500' : 'border-gray-300'
                    }`}
                ...
                <div>
                  ...
                  <input
                    ...
                    className={`w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 ${
                      formErrors.lastName?.length ? 'border-red-500' : 'border-gray-300'
                    }`}
                  ...
                  <div className="relative">
                    <input
                      ...
                      className={`w-full px-3 py-2 pr-10 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 ${
                        formErrors.email?.length ? 'border-red-500' : 'border-gray-300'
                      }`}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    className={`w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 ${
                      formErrors.company?.length ? 'border-red-500' : 'border-gray-300'
                    }`}
                    placeholder="Enter company name"
                  />
                  {formErrors.company?.length > 0 && (
                    <div className="mt-1">
                      {formErrors.company.map((error, index) => (
                        <p key={index} className="text-sm text-red-600">{error}</p>
                      ))}
                    </div>
                  )}
                ...
                <div>
                  ...
                  <input
                    ...
                    className={`w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 ${
                      formErrors.title?.length ? 'border-red-500' : 'border-gray-300'
                    }`}
                  ...
                  return (
                    <div key={platform.key}>
                      ...
                      <input
                        ...
                        className={`w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 ${
                          formErrors[`social_${platform.key}`]?.length ? 'border-red-500' : 'border-gray-300'
                        }`}
                        placeholder={platform.placeholder}
                      />
                      {formErrors[`social_${platform.key}`]?.length > 0 && (
                        <div className="mt-1">
                          {formErrors[`social_${platform.key}`].map((error, index) => (
                            <p key={index} className="text-sm text-red-600">{error}</p>
                          ))}
                        </div>
                      )}
